 ...
 form.addEventListener('submit',async (e)=>{
     ...
     try{
         const r = await axios.put('https://bankingsystemserver.herokuapp.com/transfer',{from:from_email.value,to:to_email.value,amount:amount.value,timestamp:new Date().getTime()});
         if(r.status ===200){
